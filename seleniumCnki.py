...
ActionChains(browser).double_click(browser.find_element_by_xpath('/html/body/div[2]/div[2]/div/div[1]/input[2]')).perform()
...
#//*[@id="ctl00"]/table/tbody/tr[2]/td/table/tbody/tr[2]
for i in range(1, 7):
    print(browser.find_element_by_xpath('//*[@id="ctl00"]/table/tbody/tr[2]/td/table/tbody/tr[2]/td['+str(i)+']').text)


#进入论文详情页
ActionChains(browser).double_click(browser.find_element_by_xpath('//*[@id="ctl00"]/table/tbody/tr[2]/td/table/tbody/tr[2]/td[2]/a')).perform()
...
print(browser.find_element_by_xpath('//*[@id="mainArea"]/div[3]/div[4]/div[1]/p[2]').text)
